...
(* OASIS_START *)
(* DO NOT EDIT (digest: 558883b751bd2748075986370d30956f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/drdavella";
          bugreports = None;
          synopsis = "A GameBoy Color emulator written in OCaml";
          description =
            Some [OASISText.Para "It hopefully emulates a GameBoy Color"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
     ...
     oasis_digest = Some "\137\000\217]lF\245\182\154\025P(\186A8\199";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
